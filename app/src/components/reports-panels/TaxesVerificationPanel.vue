<!-- TaxesVerificationPanel.vue -->

<template>
    <div class="panel">
        <h3>Taxes Verification Report</h3>
        <p>Select a date range or enter order IDs to generate a CSV report using WooCommerce data.</p>
        ...
        <n-modal v-model:show="showModal" preset="dialog" title="Report Ready">
            <template #default> Your Taxes Verification Report is ready for download. </template>
            <template #action>
                <a
                    :href="downloadUrl"
...
const { loading, progress: progressPercent, showModal, downloadUrl, runReport } = useReportChunks("taxes-verification", 30);
